...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = MLPRegressor().fit(train_data, train_labels)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/Multi-layer_Perceptron', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/Multi-layer_Perceptron', 'metrics_'+name_folder)
