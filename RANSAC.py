...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	train_data, train_labels = make_regression(n_samples=200, n_features=2, noise=4.0, random_state=0)
	regression = RANSACRegressor(random_state=0).fit(train_data, train_labels)
	# prever 
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/RANSAC', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/RANSAC', 'metrics_'+name_folder)
