...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = KNeighborsRegressor().fit(train_data, train_labels)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/k_neighbors', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/k_neighbors', 'metrics_'+name_folder)
