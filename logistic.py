...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = LogisticRegression().fit(train_data, training_scores_encoded)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/logistic', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/logistic', 'metrics_'+name_folder)
