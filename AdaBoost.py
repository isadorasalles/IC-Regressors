...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = AdaBoostRegressor(n_estimators= 1000, random_state=42).fit(train_data, train_labels);
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/AdaBoost', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/AdaBoost', 'metrics_'+name_folder)
