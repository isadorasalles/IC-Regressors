...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = LogisticRegressionCV().fit(train_data, training_scores_encoded)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/logistic_CV', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/logistic_CV', 'metrics_'+name_folder)
