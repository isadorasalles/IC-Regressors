...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = DummyRegressor().fit(train_data, train_labels)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/dummy', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/dummy', 'metrics_'+name_folder)
