...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = DecisionTreeRegressor().fit(train_data, train_labels);
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/decision_tree', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/decision_tree', 'metrics_'+name_folder)
