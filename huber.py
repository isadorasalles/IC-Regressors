...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/huber', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/huber', 'metrics_'+name_folder)
