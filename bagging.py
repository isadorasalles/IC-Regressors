...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	regression = BaggingRegressor(n_estimators= 1000, random_state=42).fit(train_data, train_labels);
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/bagging', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/bagging', 'metrics_'+name_folder)
