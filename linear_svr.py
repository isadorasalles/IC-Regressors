...
for folder in glob.glob("/home/isadorasalles/Documents/Regressao/train_test/*"):  #para percorrer por todas as pastas da pasta
	...
	# instancia e determina tipo de kernel e atribui demais parametros
	regression = SVR(kernel='linear',degree=1) 
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/linear_svr', 'time_'+name_folder)
	...
	output_path = os.path.join('/home/isadorasalles/Documents/Regressao/linear_svr', 'metrics_'+name_folder)
